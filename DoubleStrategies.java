 ...
 *
 */
public class DoubleStrategies extends BacktestStrategies {

	public String getStrategyName (int strategyId) { return "Double Low " + (strategyId + 5) + "s Strategy"; }

	public String getStrategyFileNameComponent (int strategyId) { return "double" + (strategyId + 5) + ".csv"; }
