 ...
 *
 */
public class MultipleExtremeRSIStrategy extends BacktestStrategies {

	private static final int[] RSI_MAXES = { 2, 5, 10 };
	...
	*/
	...
	public String getStrategyName (int strategyId) {
		...
		String toReturn = "RSI below " + rsiMax + " for " + numberOfDays + " days";
